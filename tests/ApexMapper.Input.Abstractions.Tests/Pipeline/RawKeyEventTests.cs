...
public class RawKeyEventTests
{
    ...
    {
        var a = new RawKeyEvent(ScanCode: 0xE04D, IsDown: true, TimestampTicks: 12345L, DeviceHandleIndex: 2);
        var b = new RawKeyEvent(ScanCode: 0xE04D, IsDown: true, TimestampTicks: 12345L, DeviceHandleIndex: 2);
    ...
    public void Field_round_trip_preserves_values()
    {
        ...
        evt.DeviceHandleIndex.Should().Be(7);
    }
    ...
    public void Default_event_has_zeroed_fields()
    {
        ...
        evt.DeviceHandleIndex.Should().Be((byte)0);
    }
}
